...
async function getstudentdata(classdata) {
    const response = await fetch(`/Teachers_Portal/primarygetstudentresults/`,{
        method: 'POST',
        headers: {
...
function updatestudentresult(formDataObject, classdata) {
    ...
    fetch(`/Teachers_Portal/primaryupdatestudentresults/`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': csrftoken
...
function submitallstudentresult(data, classdata) {
    ...
    fetch(`/Teachers_Portal/primarysubmitallstudentresult/`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': csrftoken
