...
from Student_Portal.models import Class
...
def signup_view(request):
    ...
    if request.method == 'POST':
        ...
        SchoolSection = request.POST['SchoolSection']
        SchoolSectionobject=schoolSection.objects.get(section=SchoolSection)
        ...
        try:
            ...
            if Role == 'ClassTeacher':
                ...
                teacher = Teacher.objects.create(
                    ...
                    SchoolSection=SchoolSectionobject
                    )
                teacher.save()
            else:
                teacher = Teacher.objects.create(
